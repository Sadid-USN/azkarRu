            ...
            children: [
              widget.index == 0
                  ...
                  : _SurahsDropdownButton(
                      audioPlayer: widget.value.audioPlayer,
                      selectedChapter: widget.value.selectedChapter,
                      quranChapters: quranChapters.entries.toList(),
                      onChapterSelected: (int chapter) {
                        widget.value.selectedChapter = chapter;
                        widget.value.refreshAudioUrls(
                            widget.value.reciterNames, chapter);
                        Future.delayed(const Duration(milliseconds: 100), () {
                          setState(() {
                            widget.value.playAudio();
                          });
                        });
                      },
                    ),
              Row(
                ...
                children: [
                  ElevatedButton(
                    onPressed: widget.value.previousPagePressed,
                  ...
                  StreamBuilder<PlayerState>(
                    stream: widget.value.audioPlayer.playerStateStream,
                    builder: (context, snapshot) {
                      ...
                      if (processingState == ProcessingState.loading ||
                        ...
                        return IconButton(
                          ...
                          iconSize: 60,
                          onPressed: widget.value.audioPlayer.stop,
                        );
                        ...
                        return IconButton(
                          ...
                          iconSize: 60,
                          onPressed: widget.value.audioPlayer.play,
                        );
                      } else {
                        return IconButton(
                          color: Colors.white,
                          ...
                          iconSize: 60,
                          onPressed: widget.value.audioPlayer.pause,
                        );
                      }
                    },
                  ),
                  ...
                  ElevatedButton(
                    onPressed: widget.value.onNextPagePressed,
                    style: ElevatedButton.styleFrom(
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(90.0),
                      ),
                  ...
                  : Row(
                      ...
                      children: [
                        StreamBuilder<PositioneData>(
                          stream: widget.value.radioPositioneDataStream,
                          builder: (context, snapshot) {
                            ...
                            return SizedBox(
                              ...
                              child: ProgressBar(
                                ...
                                onSeek: widget.value.audioPlayer.seek,
                              ),
                            );
                          },
                        ),
